...
VALIDATOR_1_WALLET_ADDRESS=$(vid-noded keys show ${VALIDATOR_1_WALLET} -a --keyring-backend=test --home=${VAL_1_HOME_DIR})
VALIDATOR_2_WALLET_ADDRESS=$(vid-noded keys show ${VALIDATOR_2_WALLET} -a --keyring-backend=test --home=${VAL_2_HOME_DIR})
