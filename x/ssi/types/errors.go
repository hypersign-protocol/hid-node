...
var (
	...
	ErrCredentialNotFound         = sdkerrors.Register(ModuleName, 118, "Credential Not Found")
	ErrInvalidCredentialStatus    = sdkerrors.Register(ModuleName, 119, "Invalid Credential Status")
	ErrInvalidDate                = sdkerrors.Register(ModuleName, 120, "Invalid Date")
	ErrInvalidCredentialField     = sdkerrors.Register(ModuleName, 121, "Invalid Credential Field")
)
