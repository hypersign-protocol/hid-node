...
type DidResolveMeta struct {
	Retrieved string `protobuf:"bytes,2,opt,name=retrieved,proto3" json:"retrieved,omitempty"`
	Error     string `protobuf:"bytes,3,opt,name=error,proto3" json:"error,omitempty"`
}

func (m *DidResolveMeta) Reset()         { *m = DidResolveMeta{} }
func (m *DidResolveMeta) String() string { return proto.CompactTextString(m) }
func (*DidResolveMeta) ProtoMessage()    {}
func (*DidResolveMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_cddfa22cf6c6aba3, []int{2}
}
func (m *DidResolveMeta) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DidResolveMeta) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DidResolveMeta.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DidResolveMeta) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DidResolveMeta.Merge(m, src)
}
func (m *DidResolveMeta) XXX_Size() int {
	return m.Size()
}
func (m *DidResolveMeta) XXX_DiscardUnknown() {
	xxx_messageInfo_DidResolveMeta.DiscardUnknown(m)
}

var xxx_messageInfo_DidResolveMeta proto.InternalMessageInfo

func (m *DidResolveMeta) GetRetrieved() string {
	if m != nil {
		return m.Retrieved
	}
	return ""
...
func (m *DidResolveMeta) GetError() string {
	if m != nil {
		return m.Error
	}
	return ""
...
func (*DidDocument) Descriptor() ([]byte, []int) {
	return fileDescriptor_cddfa22cf6c6aba3, []int{6}
}
...
func init() {
	...
	proto.RegisterType((*DidResolveMeta)(nil), "hypersignprotocol.hidnode.ssi.DidResolveMeta")
...
var fileDescriptor_cddfa22cf6c6aba3 = []byte{
	...
	,
}
...
func (m *DidResolveMeta) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DidResolveMeta) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DidResolveMeta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Error) > 0 {
		i -= len(m.Error)
		copy(dAtA[i:], m.Error)
		i = encodeVarintDid(dAtA, i, uint64(len(m.Error)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Retrieved) > 0 {
		i -= len(m.Retrieved)
		copy(dAtA[i:], m.Retrieved)
		i = encodeVarintDid(dAtA, i, uint64(len(m.Retrieved)))
		i--
		dAtA[i] = 0x12
	}
	return len(dAtA) - i, nil
...
func (m *DidResolveMeta) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DidResolveMeta) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DidResolveMeta: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DidResolveMeta: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Retrieved", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Retrieved = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
