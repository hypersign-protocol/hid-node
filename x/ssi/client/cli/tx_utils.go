...
func GetEthRecoverySignature(privateKey string, message []byte) (string, error) {
	...
	// Offset the recovery byte by 27
	// The verification function expects a signature from Web3-js library
	// Since, signature generated by go-ethereum here already has the correct recovery byte,
	// the offset is done
	sigBytes[ethercrypto.RecoveryIDOffset] += 27
