...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"hypersignprotocol", "hidnode", "did", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Dids_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 2}, []string{"hypersign-protocol", "hidnode", "did"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_GetSchema_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"hypersign-protocol", "hidnode", "did", "schema", "schemaId"}, "", runtime.AssumeColonVerbOpt(true)))
)
